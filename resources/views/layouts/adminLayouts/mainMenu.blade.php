	...
	<div class="content">
		...
		<div class="navigation">
			<ul class="menu js__accordion">
				<li id="item" class="current">
					<a class="waves-effect" href="/admin"><i class="menu-icon mdi mdi-view-dashboard"></i><span>Dashboard</span></a>
				</li>
				<li id="item" class="current">
					<a class="waves-effect" href="/admin/post"><i class="menu-icon mdi mdi-view-list"></i><span>Publications</span></a>
				</li>
				{{-- <li>
